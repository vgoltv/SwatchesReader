...
extension GPLFileRepresentation {
    ...
    init(data: Data) throws {
        ...
        var group: SRSwatchesGroup = SRSwatchesGroup(groupName:"", swatches:[] )
        let ungrouped: SRSwatchesGroup = SRSwatchesGroup(groupName:"", swatches:[] )
        ...
        for line in lines {
            ...
            if (lineStr.count>0) && !(lineStr.characterIndex(of: "#", direction: .first)==0)  {
                ...
                let swatch = SRSwatch(colorName:swatchName, color:color )
        ...
        let collection = SRSwatchesCollection(collectionName:paletteName!, groups:[group], ungrouped:ungrouped)
